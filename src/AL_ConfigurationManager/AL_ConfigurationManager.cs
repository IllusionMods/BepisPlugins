...
namespace ConfigurationManagerWrapper
{
    ...
    public class ConfigurationManagerWrapper : BasePlugin
    {
        ...
        public const string GUID = "AL_" + ConfigurationManager.ConfigurationManager.GUID;
        public const string PluginName = "Configuration Manager wrapper for AmanatsuLocation";
