...
namespace Sideloader
{
    ...
    public partial class Sideloader
    {
        ...
        internal static ConfigEntry<bool> DebugRandomizeIDs { get; private set; }
        ...
        internal void Awake()
        {
            ...
            DebugRandomizeIDs = Config.Bind("Debug", "Randomize item IDs", false,
                "Assign each item a completely random ID every time the game is started, instead of using sequential numbers that might be the same between game restarts. This can help uncover bugs in Sideloader and other plugins.");
