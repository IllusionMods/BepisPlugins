...
namespace Shared
{
    ...
    internal static class IMGUIUtils
    {
        ...
        /// <summary>
        /// Color used for solid boxes in IMGUI. This is a light gray color that is used to draw solid boxes in IMGUI.
        /// </summary>
        public static Color SolidBoxColor { get; } = ColorFilterAffectsImgui ? new Color(0.84f, 0.84f, 0.84f) : new Color(0.4f, 0.4f, 0.4f);
        /// <summary>
        /// Color used for transparent boxes in IMGUI. This is a light gray color with alpha that is used to draw semi-transparent boxes in IMGUI.
        /// </summary>
